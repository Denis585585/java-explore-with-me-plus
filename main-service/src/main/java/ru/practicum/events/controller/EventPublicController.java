...
public class EventPublicController {
    ...
    public ResponseEntity<List<UserShortDto>> publicGetLikedUsers(@PathVariable("eventId") Integer eventId,
                                                                  HttpServletRequest request) {
        saveHit(request);
        return ResponseEntity.ok().body(eventService.getLikedUsers(eventId));
    }
